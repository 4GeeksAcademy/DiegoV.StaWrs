          ...
          store.personajes.map((item, index) => { 
            ...
            return ( 
              ...
              <div className='col-2 Carta' key={index}>
                ...
                <img className='image' src={charaterImages[item.name]} alt={item.name} style={{ height: 'auto' }} />
                <br></br>
                
                  <Link className='learn btn1 btn-primary ' to={`/Character/${item.uid}`}>Learn More</Link>
